...
quantita_range = np.arange(1, 21, 1)  # Modificato per riflettere la nuova gamma
...
plt.plot(quantita_range, guadagni_dopo_invenduto[:20], marker='o')  # Usa solo i primi 20 valori
